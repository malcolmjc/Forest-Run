...
export declare function initializeSync(room: Room, synchable: any & Synchable): void;
...
export declare function room(): (proto: any, key: string) => void;
...
export declare function createBindings(room: Room, synchable: any & Synchable, synchableRoot?: any & Synchable, parentSegment?: string): void;
export declare function bindListeners(listeners: {
    [path: string]: any;
}, room: Room, synchable: any & Synchable): void;
