...
export class CurrentPlayers extends ex.UIActor {
  private state: any;
  ...
  constructor(x: number = 600, y: number = 200) {
    super(x, y, WIDTH, HEIGHT);
    this.enableCapturePointer = false;
    this.color = Config.darkGrayColor;
  }
  ...
  public onInitialize(engine: ex.Engine): void {
    ...
    const header: SubHeader = new SubHeader("Current Players:", 0, 0);
    this.add(header);
  }
